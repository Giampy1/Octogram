...
public class FolderIconController {
    ...
    public static int getPadding() {
        if (Objects.equals(OctoConfig.INSTANCE.tabMode.getValue(), OctoConfig.TAB_TYPE_MIX)) {
    ...
    public static int getTotalIconWidth() {
        int result = 0;
        if (!Objects.equals(OctoConfig.INSTANCE.tabMode.getValue(), OctoConfig.TAB_TYPE_TEXT)) {
    ...
    public static int getPaddingTab() {
        if (!Objects.equals(OctoConfig.INSTANCE.tabMode.getValue(), OctoConfig.TAB_TYPE_ICON)) {
